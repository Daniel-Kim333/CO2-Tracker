...
description1=Label(top_frame, text="These was your activities for a day:")
...
description4=Label(top_frame, text="The carbon emission you've made let glacier molten, destroy ozone layer and pollute the air")
