...
bottom_frame.grid(row=1, column=0, padx=70, pady=40, sticky="NSEW")
...
def calculate():
    ...
    # This part is to create a new text file to restore the values
    with open('data1.txt', 'w') as f:
        f.write(str(q1amount))

    with open('data2.txt', 'w') as f:
        f.write(str(q2amount))
